...
func (obj MintDKBZPDCQ) Marshal() []byte {
	buf := new(bytes.Buffer)
	obj.pack(buf)
	return buf.Bytes()
}
...
func (obj Foo6V47CVXY) Marshal() []byte {
	buf := new(bytes.Buffer)
	obj.pack(buf)
	return buf.Bytes()
}
...
func (obj Aa6UOHQXT6) Marshal() []byte {
	buf := new(bytes.Buffer)
	obj.pack(buf)
	return buf.Bytes()
}
...
func (obj AlphaCMSVNBNU) Marshal() []byte {
	buf := new(bytes.Buffer)
	obj.pack(buf)
	return buf.Bytes()
}
